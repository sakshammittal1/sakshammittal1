...
<details>
  ...
  <br>
  <blockquote>
   A lightweight, command-line application for managing a personal library. This project allows users to add, list, find, and update the status of books directly from the terminal.
  </blockquote>
  <p>
